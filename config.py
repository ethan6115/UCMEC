...
def get_config():
    ...
    parser.add_argument("--high_layer_N", type=int, default=2, help="high-level layer count")
    ...
    parser.add_argument("--high_recurrent_N", type=int, default=1, help="high-level recurrent layers")
    parser.add_argument(
        "--data_chunk_length",
        type=int,
        default=10,
    ...
    parser.add_argument("--high_gamma", type=float, default=0.99, help="high-level gamma")
    parser.add_argument("--high_gae_lambda", type=float, default=0.95, help="high-level gae lambda")
    parser.add_argument(
        "--use_proper_time_limits",
        action="store_true",
        default=False,
