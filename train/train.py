...
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            ...
            # Reason: env needs the flag to choose single vs hierarchical semantics internally.
            env_seed = all_args.seed + rank * 1000
            env_args = copy.copy(all_args)
            env_args.seed = env_seed
            env = DiscreteActionEnv(env_args)
